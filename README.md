...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-olkdedq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-olkdedq.containers.anotherwebservice.com/
...
```
git clone git@github.com:kcllu/container-olkdedq.git
cd container-olkdedq
```
...
```
docker attach container-olkdedq
```
